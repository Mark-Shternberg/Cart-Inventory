...
{
    public class all_modules_inventsModel : PageModel
    {
        private readonly IConfiguration Configuration;

        public all_modules_inventsModel(IConfiguration configuration)
        {
        ...
        public void OnGet()
        {
            ...
            using var command = new MySqlCommand("SELECT * FROM invent WHERE invent_table=1", connection);
